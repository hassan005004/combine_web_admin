...
return new class extends Migration
{
    public function up(): void
    {
        Schema::table('app_memberships', function (Blueprint $table) {
            ...
            $table->decimal('promo_discount', 8, 2)->default(0)->after('promo_code');  // absolute amount discounted
            $table->decimal('amount_paid', 8, 2)->nullable()->after('promo_discount'); // amount user actually paid

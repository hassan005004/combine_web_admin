  ...
  return (
    <aside id="sidebar" className="admin-sidebar">
      {/* <div className="admin-sidebar__brand">
        <button type="button" className="admin-sidebar__logo" onClick={() => selectedMode ? navigateSelected('dashboard') : navigate('dashboard')}>
          ...
          <span className="admin-sidebar__title">{selectedMode ? selectedEntry?.title : 'Admin Panel'}</span>
        </button>
      </div> */}
      ...
      <nav className="admin-sidebar__nav">
        {selectedMode ? (
          <>
            <div className="admin-sidebar__section">Selected Entry</div>
            <button
              type="button"
            ...
            {manageLink('features', 'Features', 'features')}
